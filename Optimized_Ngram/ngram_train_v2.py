...
python ngram_train_v2.py --train <Path to training file> --train_label <Path to training labels> --ngramrange <Range of n-grams wanted as features> 
...
python ngram_train_v2.py --train /Users/babun/Desktop/SemEval2k19/data/train_bypublisher/articles-training-bypublisher-20181122.xml --trainlabel /Users/babun/Desktop/SemEval2k19/data/train_bypublisher/ground-truth-training-bypublisher-20181122.xml --ngrange 1 1 --cutoff 10 -op1 ngram_model -op2 trainvects -op3 model_labels 
python ngram_train_v2.py --train /Users/babun/Desktop/SemEval2k19/data/train_byarticle/articles-training-byarticle-20181122.xml --trainlabel /Users/babun/Desktop/SemEval2k19/data/train_byarticle/ground-truth-training-byarticle-20181122.xml --ngrange 1 1 --cutoff 10 -op1 ngram_model -op2 trainvects -op3 model_labels 

python ngram_train_v2.py --train ~/Desktop/semeval2k19/data/train_data/train_bypub/articles-training-bypublisher-20181122.xml --trainlabel ~/Desktop/semeval2k19/data/train_data/train_bypub/ground-truth-training-bypublisher-20181122.xml --ngrange 1 1 --cutoff 10 -op1 ngram_model -op2 trainvects -op3 model_labels
...
vectorizer = CountVectorizer(ngram_range = args.ngrange , stop_words=stop_words, binary = args.onehot, min_df = 5)
...
Trained_Vectors = Trained_Vectors[:, ~np.all(Trained_Vectors == -1, axis=0)]
